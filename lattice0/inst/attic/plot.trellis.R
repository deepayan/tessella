...
##     order.cond <- aperm(order.cond, perm = x$perm.cond)
    ...
    main <- getLabelList(x$main, trellis.par.get("par.main.text"))$label
    sub <- getLabelList(x$sub, trellis.par.get("par.sub.text"))$label
    xlab <- getLabelList(x$xlab, trellis.par.get("par.xlab.text"), x$xlab.default)$label
    ylab <- getLabelList(x$ylab, trellis.par.get("par.ylab.text"), x$ylab.default, orient = 90)$label
    xlab.top <- getLabelList(x$xlab.top, trellis.par.get("par.xlab.text"))$label
    ylab.right <- getLabelList(x$ylab.right, trellis.par.get("par.ylab.text"), orient = 90)$label
